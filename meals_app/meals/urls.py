...
urlpatterns = [
    ...
    path("day_view/", views.DayView.as_view(), name="day_view"),
    path("week_view/", views.WeekView.as_view(), name="week_view"),
    path("", RedirectView.as_view(url="day_view/", permanent=True)),
    path("list_of_users/", views.list_of_users, name="list_of_users"),
    path("login/", views.Login.as_view(), name="login"),
    path("change_week/", views.DayView.as_view(), name="change_week"),
